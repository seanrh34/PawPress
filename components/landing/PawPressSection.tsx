          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8 md:p-12 border-2 border-blue-100">
            <div className="text-center mb-8">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                Want a Blog Like This for Yourself?
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-10">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Role-based access with Supabase authentication
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Powerful Lexical editor with image & embed support
                </p>
              </div>
            </div>
            ...
            <div className="text-center space-y-4">
              <p className="text-gray-700 font-medium">
                100% open source and free to use. Fork it, customize it, make it yours.
              </p>
